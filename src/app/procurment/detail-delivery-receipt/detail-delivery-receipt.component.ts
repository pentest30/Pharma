...
@Component({
  selector: 'app-detail-delivery-receipt',
  templateUrl: './detail-delivery-receipt.component.html',
  styleUrls: ['./detail-delivery-receipt.component.sass']
})
export class DetailDeliveryReceiptComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<DetailDeliveryReceiptComponent>,
  ...
  async ngOnInit(): Promise<void> {
    this.gridLines = 'Both';
    try { 
      this.deliveryReceipt = this.data.deliveryReceipt;
      this.deliveryReceipt.receiptsAmountExcTax = this.deliveryReceipt.totalAmount - this.deliveryReceipt.taxTotalAmount;
      this.isLoading = true;
    } catch (error) {
